<div class="col-md-12">
            ...
            if ($this->session->flashdata('pesan')) {
              ...
              <div class="form-group">
                       <button type = "submit" class="btn btn-primary btn-sm"style="margin-left:15px">Simpan</button>
                       <a href="<?=base_url('gambarbarang') ?>"class="btn btn-success btn-sm"style="margin-left:5px">Kembali</a>
                      </div>
              ...
              <div class="row">
                <?php foreach ($gambar as $key => $value) { ?>
                    <div class="col-sm-3">
                      ...
                      btn-block"> <i class ="fas fa-trash"></i>Delete</a>
                      </div> 
                <?php } ?>
            </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <a href="<?=base_url('gambarbarang/delete/'.$value-> id_barang . '/'. $value-> id_gambar)?>"class="btn 
